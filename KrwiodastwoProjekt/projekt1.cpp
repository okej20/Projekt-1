...
void Projekt1::on_Kalendarz_activated(const QDate &date)
{

}

void Projekt1::on_Kb_clicked()
{

}

void Projekt1::on_pushButton_3_clicked()
{

}


void Projekt1::on_radioButton_clicked()
{
    QDate current = ui->Data->date();
    QDate returnDate = current.addDays(60);
    ui->Kalendarz->setSelectedDate(returnDate);
    ui->Kalendarz->showSelectedDate();
}

void Projekt1::on_radioButton_2_clicked()
{
    QDate current = ui->Data->date();
...
void Projekt1::on_radioButton_3_clicked()
{
    QDate current = ui->Data->date();
    QDate returnDate = current.addDays(60);
    ui->Kalendarz->setSelectedDate(returnDate);
